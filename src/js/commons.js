...
$(document).ready(async function () {
  ...
  addAggCommons("murtha_cancer_center_logo", "https://prometheus.data-commons.org/", "The vision of Murtha Cancer Center Data Platform (MC2DP) is to integrate federal scientific platforms with public-private innovators revealing the impact of service-related exposures to environmental contaminants and toxin hazards and developing prevention and early detection approaches and advanced treatments of cancers arising from these exposures.", 4)
